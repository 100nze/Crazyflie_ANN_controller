...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x1853f6054ff5696557dbcef4ebeb9ef9"
#define _STAI_NETWORK_DATETIME            "2026-02-27T13:03:50+0100"
...
static const ai_i32 _actor_actor_container_actor_container_1_Tanh_output_0_t_in_0_shape_ch_prod_const_s32 = 64;


static const ai_i32 _actor_actor_container_actor_container_3_Tanh_output_0_t_in_0_shape_ch_prod_const_s32 = 64;


static const ai_i32 actions_t_in_0_shape_ch_prod_const_s32 = 4;
STAI_API_ENTRY
  ...
  const stai_run_mode mode)
{
  ...
  {
      ai_handle _actor_actor_container_actor_container_1_Tanh_output_0_t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 0);
    const ai_handle _actor_actor_container_actor_container_1_Tanh_output_0_t_in_0_ptr_const_handle = (ai_handle)(net_ctx->_activations[0] + 584);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(2, 1, {(stai_ptr) _actor_actor_container_actor_container_1_Tanh_output_0_t_in_0_ptr_const_handle});
    
  forward_lite_nl_tanh_if32of32(_actor_actor_container_actor_container_1_Tanh_output_0_t_out_0_ptr_handle, _actor_actor_container_actor_container_1_Tanh_output_0_t_in_0_ptr_const_handle, _actor_actor_container_actor_container_1_Tanh_output_0_t_in_0_shape_ch_prod_const_s32, NULL);
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(2, 1, {(stai_ptr) _actor_actor_container_actor_container_1_Tanh_output_0_t_out_0_ptr_handle});
  }
  ...
  {
      ai_handle _actor_actor_container_actor_container_3_Tanh_output_0_t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 0);
    const ai_handle _actor_actor_container_actor_container_3_Tanh_output_0_t_in_0_ptr_const_handle = (ai_handle)(net_ctx->_activations[0] + 256);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(4, 1, {(stai_ptr) _actor_actor_container_actor_container_3_Tanh_output_0_t_in_0_ptr_const_handle});
    
  forward_lite_nl_tanh_if32of32(_actor_actor_container_actor_container_3_Tanh_output_0_t_out_0_ptr_handle, _actor_actor_container_actor_container_3_Tanh_output_0_t_in_0_ptr_const_handle, _actor_actor_container_actor_container_3_Tanh_output_0_t_in_0_shape_ch_prod_const_s32, NULL);
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(4, 1, {(stai_ptr) _actor_actor_container_actor_container_3_Tanh_output_0_t_out_0_ptr_handle});
  }
  ...
  {
      ai_handle actions_t_out_0_ptr_handle = (ai_handle)(net_ctx->_outputs[0] + 0);
    const ai_handle actions_t_in_0_ptr_const_handle = (ai_handle)(net_ctx->_activations[0] + 256);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(6, 1, {(stai_ptr) actions_t_in_0_ptr_const_handle});
    
  forward_lite_nl_tanh_if32of32(actions_t_out_0_ptr_handle, actions_t_in_0_ptr_const_handle, actions_t_in_0_shape_ch_prod_const_s32, NULL);
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(6, 1, {(stai_ptr) actions_t_out_0_ptr_handle});
  }
